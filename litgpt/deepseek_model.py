...
from litgpt.model import Block as BaseBlock, LLaMAMLP, GPT


class DeepseekBlock(BaseBlock):
    ...
    def __init__(self, config: DeepseekConfig, block_idx: int) -> None:
        ...
        # DeepSeek MoE specific: first block uses regular LLaMAMLP instead of DeepseekMoE
        if config.mlp_class_name == "DeepseekMoE" and block_idx == 0:
...
class DeepseekGPT(GPT):
    ...
    def __init__(self, config: DeepseekConfig) -> None:
        # We need to temporarily change the Block class before calling super().__init__
